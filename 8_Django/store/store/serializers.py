...
class ProductSerializer(serializers.ModelSerializer):
    ...
    sale_start = serializers.DateTimeField(
        ...
        help_text='Accepted format is "12:01 PM 11 January 2021"',
        style={'input_type': 'text', 'placeholder': '12:01 AM 11 January 2021'},
        required=False,
    )
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'description', 'price', 'sale_start', 'sale_end',
                'is_on_sale', 'current_price', 'sale_start', 'sale_end',
                'photo', 'warranty', 'cart_items',
            )
