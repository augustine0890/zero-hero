...
class ProdcutCreateTestCase(APITestCase):
    ...
    def test_create_product(self):
        ...
        product_attrs = {
            ...
            'price': '124.43',
            # 'sale_start': '12:01 AM 11 January 2021',
            # 'sale_end': '12:01 AM 15 January 2021',
        }
...
class ProductDestroyTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.client.post('/api/v1/products/new', product_attrs)
